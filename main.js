...
document.getElementById("todraw").innerText = 'Sketch To be Drawn: ' + sketch;
var timer_counter = 0;
var timer_check = "";
var drawn_sketch = "";
var answer_holder = "";
...
function updateSketch() {
    ...
    var sketch = quick_draw_data_set[random_number];
    document.getElementById("sketchSpan").innerText = 'Sketch To be Drawn: ' + sketch;
...
function check_sketch() {
    console.log("Current Timer Counter:", timer_counter);
    document.getElementById("timerSpan").innerText = 'Timer: ' + timer_counter;
    console.log("Current Timer Counter:", timer_counter);
    if (timer_counter > 400) {
        timer_counter = 0;
        timer_check = "completed";
        console.log("Time limit reached! Do something...");
    }
